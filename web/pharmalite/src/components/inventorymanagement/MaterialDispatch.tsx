      ...
      <Grid container spacing={2}>
        ...
        <Card>
          <CardContent>
            ...
            >
              <Tab className={value==='Material Dispatch' ? "active-tab" : "in-active-tab"} value="Material Dispatch" label="Material Dispatch" />
              <Tab className={value==='Material Dispatch History' ? "active-tab" : "in-active-tab"}
